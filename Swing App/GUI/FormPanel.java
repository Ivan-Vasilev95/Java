	...
	public FormPanel() {
		...
		okBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String Country=CitizenshipField.getText();
				...
				if(maleRadio.isSelected()||femaleRadio.isSelected()) {
					...
					FormEvent ev = new FormEvent(this, name, occupation, ageCat.getID(), empCat,Country,usCitizen,genderCommand);
					
					if (formListener != null) {
						formListener.formEventOccured(ev);
					}
				}else {
					JOptionPane.showMessageDialog(FormPanel.this, "Gender was not selected", "Error",
